...
{/* AI-Ref: CSS-Grid-Gallery */}
      ...
      {lightboxOpen && hasImages && (
          ...
          >
              ...
              <button 
                  onClick={prevImage}
                  className="absolute left-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white p-4 bg-black/20 hover:bg-black/40 rounded-full transition-all z-50"
              >
              ...
              <button 
                  onClick={nextImage}
                  className="absolute right-4 top-1/2 -translate-y-1/2 text-white/70 hover:text-white p-4 bg-black/20 hover:bg-black/40 rounded-full transition-all z-50"
              >
