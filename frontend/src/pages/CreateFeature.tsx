...
import { ArrowLeft, Loader2, Settings, Plus, AlignLeft } from "lucide-react";

const CreateFeature = () => {
  const { titel, setTitel, beschreibung, setBeschreibung, loading, handleSubmit, navigate } = useCreateFeature();
    ...
    <div className="min-h-screen bg-slate-100 font-sans pb-20">
      ...
      <main className="pt-32 px-6 max-w-2xl mx-auto">
        <div className="mb-6">
            ...
            <h1 className="text-3xl font-bold text-slate-900 mt-2">Neues Feature erstellen</h1>
        </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input 
                                required 
                                className="pl-9"
                                placeholder="z.B. WLAN, Pool, Balkon..."
                                value={titel}
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            ...
                            <Input 
                                className="pl-9"
                                placeholder="z.B. Kostenloses Highspeed-Internet..."
                                value={beschreibung}
                    ...
                    <Button 
                        ...
                        disabled={loading}
                    >
                        {loading ? <><Loader2 className="mr-2 h-5 w-5 animate-spin"/> Speichere...</> : <><Plus className="mr-2 h-5 w-5"/> Feature anlegen</>}
                    </Button>
                </form>
            </CardContent>
        </Card>
